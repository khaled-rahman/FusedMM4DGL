...
class EdgeWeightNorm2(nn.Module):
    r"""
    Description
    -----------
    ...
    def forward(self, graph, edge_weight):
        ...
        with graph.local_scope():
            ...
            if self._norm == 'both':
                ...
                reversed_g.update_all_fused(fn.copy_edge('_edge_w', 'm'), fn.sum('m', 'out_weight'))
                degs = reversed_g.dstdata['out_weight'] + self._eps
                norm = th.pow(degs, -0.5)
                graph.srcdata['_src_out_w'] = norm

            if self._norm != 'none':
                graph.update_all_fused(fn.copy_edge('_edge_w', 'm'), fn.sum('m', 'in_weight'))
    ...
    def forward(self, graph, feat, weight=None, edge_weight=None):
        ...
        * Weight shape: :math:`(\text{in_feats}, \text{out_feats})`.
        ...
        with graph.local_scope():
            ...
            aggregate_fn = fn.fused_copy_u('h', 'm')
