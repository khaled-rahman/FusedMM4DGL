...
from .graphconv2 import GraphConv2
...
__all__ = ['GraphConv', 'GraphConv2', 'EdgeWeightNorm', 'GATConv', 'GATConv2', 'GATv2Conv', 'EGATConv',
            'TAGConv', 'RelGraphConv', 'SAGEConv', 'SGConv', 'APPNPConv', 'GINConv', 'GatedGraphConv',
